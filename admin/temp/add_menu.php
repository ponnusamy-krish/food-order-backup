...
if (isset($_POST['submit'])){
        ...
        $additionalQuantity = isset($_POST['product']) ? implode(',', $_POST['product']) : '';
        ...
        for ($i = 0; $i < count($_FILES['file']['name']); $i++) {
            ...
            if (move_uploaded_file($temp, $store)) {
                ...
                $sql = "INSERT INTO dishes(dish_name,category,description ,price,discount,Total_Quantity,Additional_quantity,stock,best_before,food_type,keywords,img,img2,img3,img4,img5) VALUE('" . $_POST['d_name'] . "','" . $_POST['category'] . "','" . $_POST['price'] . "','" . $_POST['discount'] . "', '" . $_POST['discount'] . "', '" . $_POST['about'] . "',   '" . $_POST['total_quantity'] . "',   '" . $additionalQuantity . "' ,   '" . $_POST['stock'] . "'       ,   '" . $_POST['exp_date'] . "'        ,   '" . $_POST['food_type'] . "'        ,   '" . $_POST['keywords'] . "','" . $imagePaths[0] . "', '" . $imagePaths[1] . "', '" . $imagePaths[2] . "', '" . $imagePaths[3] . "', '" . $imagePaths[4] . "')"; 
                mysqli_query($db, $sql);
